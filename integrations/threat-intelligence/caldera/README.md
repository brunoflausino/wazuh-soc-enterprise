...
![Alerts over time and top tactics](assets/dashboard-alerts-timeline.png)

### Attacks by technique + Top tactics by agent + MITRE techniques by agent

![Attacks by technique panels](assets/dashboard-attacks-by-technique.png)

### Full MITRE ATT&CK dashboard view

![Full dashboard view](assets/dashboard-full-view.png)
